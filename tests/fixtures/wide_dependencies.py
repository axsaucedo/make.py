...
def setup_a():
    """Setup component A"""
    echo('Setting up component A')

def setup_b():
    """Setup component B"""
    echo('Setting up component B')

def setup_c():
    """Setup component C"""
    echo('Setting up component C')

def setup_d():
    """Setup component D"""
    echo('Setting up component D')

@dep(setup_a, setup_b, setup_c, setup_d)
def setup_all():
    """Initialize all components"""
    echo(f'All components initialized with {WORKERS} workers')

# Convergent pattern - multiple paths to same dependencies
@dep(setup_all)
def process_a():
    """Process data stream A"""
    echo('Processing data stream A')

@dep(setup_all)
def process_b():
    """Process data stream B"""
    echo('Processing data stream B')
